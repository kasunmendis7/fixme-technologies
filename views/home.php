            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Your Safety is Our Priority: From strict vetting processes to real-time support, we ensure a secure experience with every interaction                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Ensuring Fairness for Technicians: With upfront payments and verified customer profiles, we protect your time and effort from potential fraud
                        </p>
                    </div>
                </div>
            </div>
