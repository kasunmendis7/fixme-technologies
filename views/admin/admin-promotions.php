...
<body>
<?php include_once 'components/sidebar.php'; include_once 'components/header.php'; ?> 
            ...
            <div class="modal-content">
                ...
                <form id="promotion-form" class="modal-form" method="post" action="/promotion/add">
                    ...
                    <div class="modal-buttons">
                        ...
                        <button type="button" class="button gray" onclick="document.getElementById('form-modal').classList.add('hidden')">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form id="promotion-edit-form" class="modal-form" method="post" action="/promotion/update">
                    ...
                    <div class="modal-buttons">
                        ...
                        <button type="button" class="button gray" onclick="document.getElementById('form-modal1').classList.add('hidden')">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
