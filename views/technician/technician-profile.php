...
<div class="cust-profile ">
    <form method="post" id="profileForm" action="/update-technician-profile" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-4">
                <div class="profile-img">
                    <img src="<?php echo Application::$app->technician->{'profile_picture'} ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="fname" id="firstNameInput"
                                               value="<?php echo Application::$app->technician->{'fname'} ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="lname" id="lastNameInput"
                                               value="<?php echo Application::$app->technician->{'lname'} ?>"
                                               class="edit-input" style="display:none;">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" name="phone_no" id="phoneNoInput"
                                               value="<?php echo Application::$app->technician->{'phone_no'} ?>"
                                               class="edit-input" style="display:none;">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="address" id="addressInput"
                                               value="<?php echo Application::$app->technician->{'address'} ?>"
                                               class="edit-input" style="display:none;">
                                    </div>
                                </div>
                            </div>
