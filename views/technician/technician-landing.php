...
<head>
    ...
    <title>Technician Landing Page</title>
    <link rel="stylesheet" href="/css/technician/technician-landing.css">
    <link rel="stylesheet" href="/css/technician/navbar.css">
    <link rel="stylesheet" href="/css/technician/footer.css">
    <script src="/js/technician/technician-landing.js"></script>
</head>
<body>
<nav class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <div class="col-md-3 text-center">
            ...
            <button type="button" class="btn btn-primary"><a class="text-decoration-none" onclick="redirectToSignUp()">Sign Up</a></button>
        </div>
    </header>
    ...
    <div class="container-landing-page">
        ...
        <div class="header-landing-page">
            <div class="header-content">
                <div class="left-side">
                    <h1>Professional <span class="blue-text">Car</span> Repair and <span
                                class="blue-text">Maintenance</span>. Join the FixMe Network.</h1>
                </div>
...
<section class="section2">
    <div class="image-content">
        <img src="/assets/technician-landing-page-image.png" alt="technician-landing-page"
...
<section class="section3">
    <div class="container-landing-page">
        <div class="header-landing-page">
            <div class="header-content">
                <div class="left-side">
                    <img src="/assets/section-3-image.webp" alt="technician-landing-page"
                         class="technician-image">
                </div>
                <div class="right-side">
                    <h1>Our Platform aims to make it <span class="blue-text">Easier for Vehicle Owners</span> to connect
                        with Reliable Technicians,<span class="blue-text"> ensuring Quick and Efficient</span>. Repair
                        Services.</h1>
                    <p class="tagline">Our primary objective is to develop a comprehensive web-based platform to
                        streamline the process of finding and hiring skilled technicians and service centers for vehicle
                        repair services.</p>
                    <ul>
                        <li>Advance Payment System</li>
        ...
        <div class="header-landing-page">
            <div class="faq-section">
                <div class="left-side">
                    ...
                    <div class="faq-item">
                        <h3>What are the requirements to join the FixMe network?</h3>
                        <p>To join the FixMe network, you need to have a valid technician certification and a minimum of two years of experience in the automotive repair industry.</p>
                    </div>
                    <div class="faq-item">
                        <h3>How do I sign up?</h3>
                        <p>Click the 'Sign Up' button at the top of the page and fill out the registration form with
                            your details.</p>
                    </div>
                    <div class="faq-item">
                        <h3>What benefits do I get as a FixMe technician?</h3>
                        <p>As a FixMe technician, you get access to a wide customer base, flexible working hours, and
                            competitive service fees.</p>
                    </div>
                </div>
                <div class="right-side">
                    <img src="/assets/faq-section-image.jpg" alt="technician-landing-page"
                         class="faq-image">
                </div>
            </div>
        </div>
