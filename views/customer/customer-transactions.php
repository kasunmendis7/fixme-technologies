...
<head>
    ...
    <link rel="stylesheet" href="/css/customer/customer-transactions.css">
</head>
...
<div class="container">
    <div class="header">
        <div class="header-item">
            <?php
            $paymentDone = number_format($revenue, 2, '.', ',');
            ?>
            <div class="total-payments">
                <p>Total Payments</p>
                <h2>LKR <?php echo $paymentDone ?></h2>
                <small>as of <?php echo date('d-F-Y') ?></small>
            </div>
        </div>
        <div class="header-item">
            <?php
            $paymentPending = number_format($totalPending, 2, '.', ',');
            ?>
            <div class="pending-payments">
                <p>Pending Payments</p>
                <h2>LKR <?php echo $paymentPending ?></h2>
                <small>as of <?php echo date('d-F-Y') ?></small>
            </div>
        </div>
    </div>
...
<script src="/js/customer/customer-transactions.js"></script>
</body>
