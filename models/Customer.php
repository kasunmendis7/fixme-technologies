...
class Customer extends DbModel
{
    ...
    public function getAllTechniciansSortedByDistance()
    {
        try {
            ...
            return [
                'status' => 'success',
                'data' => $technicians,
                'message' => 'Techinicians fetched successfully'
            ];

        } catch (\Exception $e) {
            error_log("Error in getAllTechniciansSortedByDistance: " . $e->getMessage());
            return [
                'status' => 'error',
                'data' => [],
                'message' => 'An unexpected error occurred while retrieving technicians.'
            ];
        }
    }
    ...
    public function getAllServiceCentersSortedByDistance()
    {
        try {
            ...
            error_log("Error in getAllServiceCentersSortedByDistance: " . $e->getMessage());
            return [
                'status' => 'error',
                'data' => [],
                'message' => 'An unexpected error occurred while fetching service centers.'
            ];
        }
